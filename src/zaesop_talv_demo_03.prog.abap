*&---------------------------------------------------------------------*
*& Report ZAESOP_TALV_DEMO_03
*&---------------------------------------------------------------------*
*&  同一个会话内如果需要使用多个TALV，则对应form名里的屏幕编号递增1即可,起始9000
*&---------------------------------------------------------------------*
REPORT zaesop_talv_demo_03.
...
FORM frm_9001_handle_set_title.
...
FORM frm_9001_handle_retrieve USING pv_ddic_type TYPE tabname
                           CHANGING alv_table TYPE STANDARD TABLE.
